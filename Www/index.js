...
import {expFaq} from './src/scripts/product/faq.js';
...
app.get('/faq', (req, res) => {
    let faq = new expFaq()
    faq.load().then(response => {
        divfaq = response.data
        //console.log(response.data)
        console.log(response.data);
        //Render the page when the data are loaded
        res.render(path.join(__dirname, "/src/frontend/faq/faq"), {
                                                                            title : 'faq !',
                                                                            idFaq : idFaq,
                                                                            question : question,
                                                                            id: null,
...
app.get('/faq/:uid', (req, res) => {
    let faq = new expFaq()
    //console.log(req.params.uid)
    faq.load(req.params.uid).then(response => {
        divfaq = response.data
        //console.log(response.data)
        console.log(response.data);
        //Render the page when the data are loaded
        res.render(path.join(__dirname, "/src/frontend/faq/answer"), {
                                                                            title : 'faq !',
                                                                            question : question,
                                                                            pseudo : pseudo,
                                                                            answer : divFaq,
